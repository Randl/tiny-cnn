...
TEST(concat, forward_data2) {
  std::vector<shape3d> in_shapes;
  in_shapes.push_back(shape3d(1, 2, 2));
  in_shapes.push_back(shape3d(1, 2, 3));
  in_shapes.push_back(shape3d(1, 2, 1));
  concat_layer cl(in_shapes);
  ...
  tensor_t out_expected = {{ 0,  1,  0,  1,  2,  3,  2,  3,  2,  3,  4,  5},
                           { 6,  7,  6,  7,  8,  9,  8,  9,  8,  9, 10, 11},
                           {12, 13, 12, 13, 14, 15, 14, 15, 14, 15, 16, 17},
                           {18, 19, 18, 19, 20, 21, 20, 21, 20, 21, 22, 23}};
